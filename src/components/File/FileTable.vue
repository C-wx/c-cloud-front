      ...
      <el-table-column :width="operaColumnWidth" key="action">
        <template slot="header">
          ...
          <i
            ...
            title="展开"
            @click="operaColumnExpand = true"
          ></i>
          <i
            class="el-icon-remove"
            title="折叠"
            @click="operaColumnExpand = false"
          ></i>
        </template>
        <template slot-scope="scope">
          <div v-if="operaColumnExpand">
            ...
            <el-button
              ...
              v-if="
                unzipBtnShow && ['zip', 'rar'].includes(scope.row.extendName)
              "
              >解压缩</el-button
            >
            <el-button
              ...
              size="mini"
              @click="
                copyShareLink(scope.row.shareBatchNum, scope.row.extractionCode)
              "
          ...
          <el-dropdown trigger="click" v-else>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item
                ...
                @click.native="
                  copyShareLink(
                    scope.row.shareBatchNum,
                    scope.row.extractionCode
                  )
                "
  ...
  methods: {
    ...
    setFileImg(row) {
      if (!row.extendName) {
        ...
        this.fileType !== 6 &&
        ['jpg', 'png', 'jpeg', 'gif'].includes(row.extendName)
      ) {
        // 图片类型，直接显示缩略图
